...
\begin{itemize}
	...
	\begin{enumerate}
		\item Write a Lay Summary{\it (completed)}
		\item Study the operation of GitHub {\it (completed)}
		\item Create a public repository in GitHub for the C ++ operating model {\it (completed)}
		\item Write a README for the project{\it (completed)}
		\item Rewrite PIBIC proposal. {\it (completed)}
	\end{enumerate}
	
	\item Initial date: 29/05/2017 -- Final date: 05/06/2017
	\begin{enumerate}
		\item Build a UML diagram{\it (not completed)}
		\item Rewrite the Lay Summary {\it (completed)}
		\item Rewrite the README{\it (completed)}		
	\end{enumerate}
	
	\item Initial date: 05/06/2017 -- Final date: 12/06/2017
	\begin{enumerate}
		\item Finish the UML diagram{\it ( completed)}
		\item Read articles about ESBMC++ {\it (completed)}
				
	\end{enumerate}
	
	\item Initial date: 12/06/2017 -- Final date: 19/06/2017
	\begin{enumerate}
		\item Build a hierarchy diagram of C ++ libraries {\it (to do)}
		\item Add Improvements to UML Diagrams {\it (to do)}
